    ...
    <main className="min-h-screen">
      ...
      <div className="mx-auto flex max-w-7xl gap-6 px-4 py-6 md:px-6 md:py-8">
          ...
          <div className="sticky top-6 space-y-4">
            <div className="rounded-3xl bg-slate-950/95 p-5 text-white shadow-soft ring-1 ring-white/10">
              ...
              <div className="mt-4 rounded-2xl bg-white/5 p-4 ring-1 ring-white/10">
                ...
                <div className="mt-1 text-sm font-semibold">Asma Ahmed</div>
                <div className="mt-1 text-xs text-white/70">
                  Inspired by a love for law + tech — combining both into one AI legal workflow platform.
                </div>

                <div className="mt-3 flex flex-wrap gap-x-3 gap-y-2 text-xs text-white/70">
                  <Link className="underline decoration-white/30 underline-offset-4 hover:text-white" href="/about">
                    About
                  </Link>
                  <span className="text-white/30">•</span>
                  <Link className="underline decoration-white/30 underline-offset-4 hover:text-white" href="/contact">
                    Contact
                  </Link>
                  <span className="text-white/30">•</span>
                  <Link className="underline decoration-white/30 underline-offset-4 hover:text-white" href="/privacy">
                    Privacy
                  </Link>
                  <span className="text-white/30">•</span>
                  <Link className="underline decoration-white/30 underline-offset-4 hover:text-white" href="/terms">
                    Terms
                  </Link>
                </div>
              </div>
        ...
        <div className="flex-1 space-y-6">
          ...
          <div className="flex items-center justify-between gap-4">
            <div className="flex items-center gap-3 md:hidden">
              ...
              <div>
                ...
                <div className="text-xs text-slate-600 dark:text-white/70">AI Legal Platform</div>
              </div>
            </div>
            ...
            <div className="ml-auto flex items-center gap-3">
              ...
              <a
                ...
                title="Open LegalAssist web app"
              >
                Sign In
              </a>
            </div>
          ...
          {/* Hero */}
          <section id="overview" className="rounded-[28px] border border-white/50 bg-white/70 p-6 shadow-soft backdrop-blur md:p-8 dark:border-white/10 dark:bg-slate-950/30">
            ...
            <div className="mt-6 grid gap-4 md:grid-cols-4">
              {[
                ...
                <div key={c.k} className="glass-card glow-card group rounded-2xl p-4 transition hover:-translate-y-0.5">
          ...
          <section id="features" className="rounded-[28px] border border-white/50 bg-white/70 p-6 shadow-soft backdrop-blur md:p-8 dark:border-white/10 dark:bg-slate-950/30">
            ...
            <div className="mt-6 grid gap-4 md:grid-cols-3">
              {[
                { title: "Client & Case Management", desc: "CRM-style clients and matters with clean navigation — just like a firm system." },
          ...
          >
            ...
            <div className="mt-6 grid gap-4 md:grid-cols-2">
              {screens.map((s) => (
                <div key={s.src} className="glass-card glow-card group overflow-hidden rounded-3xl shadow-soft transition hover:-translate-y-0.5">
              ...
              {[
                ...
                <details key={item.q} className="glass-card glow-card group rounded-3xl p-5 transition">
                  <summary className="cursor-pointer list-none text-sm font-semibold text-slate-900 dark:text-white">
                    <span className="mr-2 inline-block rounded-lg bg-ink-600/10 px-2 py-1 text-xs font-semibold text-ink-800 dark:text-ink-200">
                      Q
                    </span>
                    {item.q}
