      ...
      <div className="mx-auto flex max-w-7xl gap-6 px-4 py-6 md:px-6 md:py-8">
        ...
        <aside className="hidden w-[270px] shrink-0 md:block">
          <div className="sticky top-6 space-y-4">
            ...
            <div className="rounded-3xl bg-white/70 p-4 shadow-soft ring-1 ring-white/50 backdrop-blur dark:bg-white/5 dark:ring-white/10">
              <div className="text-xs text-slate-600 dark:text-slate-200">Built by</div>
              <div className="mt-1 text-sm font-semibold text-slate-900 dark:text-white">Asma Ahmed</div>
              <div className="mt-2 text-xs text-slate-600 dark:text-slate-300">
                Inspired by a love for <span className="font-semibold">law</span> + <span className="font-semibold">tech</span> — combining both into one AI legal workflow platform.
              </div>
            </div>
          </div>
        </aside>
        ...
        <div className="flex-1 space-y-6">
          ...
          <div className="flex items-center justify-between gap-4">
            <div className="flex items-center gap-3 md:hidden">
              ...
              <div>
                <div className="font-semibold leading-tight text-slate-900 dark:text-white">LegalAssist</div>
          ...
          {/* Hero */}
          <section id="overview" className="rounded-[28px] border border-white/50 bg-white/70 p-6 shadow-soft backdrop-blur md:p-8 dark:border-white/10 dark:bg-white/5">
          ...
          {/* Features */}
          <section id="features" className="rounded-[28px] border border-white/50 bg-white/70 p-6 shadow-soft backdrop-blur md:p-8 dark:border-white/10 dark:bg-slate-950/30">
            <AnimatedText
              as="h2"
              variant="type"
              speedMs={18}
          ...
          {/* Demo Video */}
          <section id="demo" className="rounded-[28px] border border-white/50 bg-white/70 p-6 shadow-soft backdrop-blur md:p-8 dark:border-white/10 dark:bg-slate-950/30">
            <AnimatedText
              as="h2"
              variant="type"
              speedMs={18}
            ...
            <div className="mt-4 text-sm text-slate-600 dark:text-slate-300">
              ...
              <a
                className="font-semibold text-ink-700 underline decoration-ink-300 underline-offset-4 hover:text-ink-900 dark:text-ink-200 dark:hover:text-white"
          ...
          {/* Screens */}
          <section id="screens" className="rounded-[28px] border border-white/50 bg-white/70 p-6 shadow-soft backdrop-blur md:p-8 dark:border-white/10 dark:bg-slate-950/30">
            <AnimatedText
              as="h2"
              variant="type"
              speedMs={18}
          ...
          {/* FAQ */}
          <section id="faq" className="rounded-[28px] border border-white/50 bg-white/70 p-6 shadow-soft backdrop-blur md:p-8 dark:border-white/10 dark:bg-slate-950/30">
            <AnimatedText
              as="h2"
              variant="type"
              speedMs={18}
            ...
            <div className="mt-6 grid gap-4">
              {[
                ...
                <details key={item.q} className="glass-card glow-card group rounded-3xl p-5 transition">
                  <summary className="cursor-pointer list-none text-sm font-semibold text-slate-900 dark:text-white">
                    <span className="mr-2 inline-block rounded-lg bg-ink-600/10 px-2 py-1 text-xs font-semibold text-ink-800 dark:text-ink-100">
                      Q
                    </span>
                    {item.q}
          ...
          {/* Waitlist + Footer */}
          <section id="waitlist" className="rounded-[28px] border border-white/50 bg-white/70 p-6 shadow-soft backdrop-blur md:p-8 dark:border-white/10 dark:bg-white/5">
            <AnimatedText
              as="h2"
              variant="type"
              speedMs={18}
            ...
            <div className="mt-6 flex flex-wrap items-center gap-3">
              ...
              <div className="text-xs text-slate-500 dark:text-slate-300">No spam — just early access updates.</div>
            </div>

            <div className="glass-card glow-card mt-6 rounded-2xl px-4 py-3 text-xs text-slate-600 dark:text-slate-200">
              <div className="font-semibold text-slate-900 dark:text-white">Built by Asma Ahmed</div>
              <div className="mt-1">
                LegalAssist does not provide legal advice and does not create an attorney-client relationship. AI-generated content is for informational purposes only.
              </div>

              <div className="mt-3 flex flex-wrap items-center gap-x-3 gap-y-1">
                <Link className="text-ink-700 underline decoration-ink-300 underline-offset-4 hover:text-ink-900 dark:text-ink-200 dark:hover:text-white" href="/about">
                  About
                </Link>
                ...
                <span className="ml-auto text-slate-500 dark:text-slate-300">© 2026 LegalAssist</span>
              </div>
            </div>
          </section>
        </div>
